...
- এই রিপোটা চোখে পড়েছে, কিন্তু **এজেন্ট**, **MCP**, **JSON**, **ফর্ক**—এই ভারী ইংরেজি টেকনিক্যাল শব্দগুলো শুনে কিছুই মাথায় ঢুকছে না? একদম ভয় পাবেন না।
...
| **JSON** | ফাইলে আপনার টাকার হিসাব বা ডেটা গুছিয়ে রাখার একটা পাওয়ারফুল আর সিম্পল ফরম্যাট। দেখতে এমন হয়: `"basic_pay": 50000`। |
